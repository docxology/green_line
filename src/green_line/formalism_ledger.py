"""Derivation of ``data/formalism_claim_ledger.json`` from the manuscript blocks."""
...
def build_ledger() -> str:
    """Derive the citation rows, write the ledger, and return the summary line."""
    ...
    return f"wrote {OUT} with {len(rows)} rows"
